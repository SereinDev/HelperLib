...
declare interface HardwareInfo {
    ...
    readonly batteryList: readonly Battery[];

    readonly biosList: readonly Bios[];

    readonly computerSystemList: readonly ComputerSystem[];

    readonly cpuList: readonly Cpu[];

    readonly driveList: readonly Drive[];

    readonly keyboardList: readonly Keyboard[];

    readonly memoryList: readonly Memory[];

    readonly monitorList: readonly Monitor[];

    readonly motherboardList: readonly Motherboard[];

    readonly mouseList: readonly Mouse[];

    readonly networkAdapterList: readonly ClrType[];

    readonly printerList: readonly Printer[];

    readonly soundDeviceList: readonly SoundDevice[];

    readonly videoControllerList: readonly VideoController[];
}
...
declare interface Cpu {
    ...
    get cpuCoreList(): readonly CpuCore[];
}
...
declare interface Drive {
    get partitionList(): readonly Partition[];
...
declare interface Partition {
    get volumeList(): readonly Volume[];
